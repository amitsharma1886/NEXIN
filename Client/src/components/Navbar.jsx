            ...
            <ul className="flex space-x-8">
              {navItems.map((item) => (
                <li key={item.name}>
                  <Link
                    to={item.path}
                    className={`text-gray-300 hover:text-electric-400 transition-colors relative group ${
            ...
            {isLoggedIn ? (
              <>
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-full bg-red-500 hover:bg-red-600 text-white transition-all"
                >
                  Logout
                </button>
              </>
            ...
            {isLoggedIn ? (
              <>
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-full bg-red-500 text-white text-center hover:bg-red-600 transition-all"
                >
                  Logout
                </button>
              </>
